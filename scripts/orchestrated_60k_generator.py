...
def main():
    ...
    google_keys = [(acc["name"], acc["google_api_key"]) for acc in accounts if acc["google_api_key"]]
    groq_keys = [(acc["name"], acc["groq_api_key"]) for acc in accounts if acc["groq_api_key"]]
