...
CORRECTION_CHECKPOINT = Path("/home/mohanganesh/ship/training/checkpoints/correction-1.7b/final")
ORPO_CHECKPOINT = Path("/home/mohanganesh/ship/training/checkpoints/orpo-1.7b")
BASE_MODEL = "/home/mohanganesh/ship/models/student-1.7b"
ORPO_DATA = Path("/home/mohanganesh/ship/ship/maritime_pipeline/data/final/orpo_pairs_1.7b.jsonl")
...
def main():
    ...
    log_pipeline("PHASE_4_ORPO_1.7B STATUS: TRAINING STARTED")
    ...
    log_pipeline("PHASE_4_ORPO_1.7B STATUS: COMPLETE. Run gate check now.")
