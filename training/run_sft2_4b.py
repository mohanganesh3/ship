...
SFT1_CHECKPOINT = Path("/home/mohanganesh/ship/training/checkpoints/sft1-4b/final")
SFT2_CHECKPOINT = Path("/home/mohanganesh/ship/training/checkpoints/sft2-4b")
...
def main():
    ...
    log_pipeline("PHASE_2B_SFT2_4B STATUS: TRAINING STARTED")
    trainer.train()
