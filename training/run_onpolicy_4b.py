...
STUDENT_ANSWERS = Path("/home/mohanganesh/ship/ship/maritime_pipeline/data/generation/student_answers_4b.jsonl")
TEACHER_JUDGMENTS = Path("/home/mohanganesh/ship/ship/maritime_pipeline/data/generation/teacher_judgments_4b.jsonl")
SFT_CORRECTIONS = Path("/home/mohanganesh/ship/ship/maritime_pipeline/data/final/sft_corrections_4b.jsonl")
ORPO_PAIRS = Path("/home/mohanganesh/ship/ship/maritime_pipeline/data/final/orpo_pairs_4b.jsonl")
...
def main():
    ...
    if teacher_port is None:
        log_pipeline("PHASE_3_ONPOLICY_4B STATUS: FAIL — no teacher server alive on any port")
