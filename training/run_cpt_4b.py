#!/usr/bin/env python3
"""
CPT for Qwen3-4B — CPU-only, fp32 LoRA r=128
...
PER_DEVICE_BATCH = 2   # Batch=4 with seq=512 = 2048 tokens/step, good CPU vectorization
GRAD_ACCUM = 16         # Effective batch = 32 samples = 16384 tokens
...
def main():
    ...
    if args.dry_run:
        ...
        log_pipeline("PHASE_1A_CPT_4B STATUS: STARTING. CPU-only fp32 LoRA r=128")
